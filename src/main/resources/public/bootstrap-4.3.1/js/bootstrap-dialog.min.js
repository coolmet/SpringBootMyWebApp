		...
		if (typeof module !== "undefined" && module.exports)
		...
		else
			{
				if (typeof define === "function" && define.amd)
					{
						define("bootstrap-dialog",
							[ "jquery", "bootstrap" ], function(c)
							{
								return b(c)
							})
					}
	...
	}(this, function(d)
	{
		...
		a.prototype = {
			...
			initModalStuff : function()
				{
					this.setModal(this.createModal()).setModalDialog(this.createModalDialog()).setModalContent(this.createModalContent()).setModalHeader(this.createModalHeader()).setModalBody(this.createModalBody()).setModalFooter(
			...
			createModal : function()
				{
					var e = d('<div class="modal" role="dialog" aria-hidden="true"></div>');
			...
			updateType : function()
				{
					if (this.isRealized())
						{
							var e =
								[ a.TYPE_DEFAULT, a.TYPE_INFO, a.TYPE_PRIMARY, a.TYPE_SECONDARY, a.TYPE_SUCCESS, a.TYPE_WARNING, a.TYPE_DARK, a.TYPE_LIGHT, a.TYPE_DANGER ];
			...
			updateSize : function()
				{
					if (this.isRealized())
						{
							var e = this;
							this.getModal().removeClass(a.SIZE_NORMAL).removeClass(a.SIZE_SMALL).removeClass(a.SIZE_WIDE).removeClass(a.SIZE_EXTRAWIDE).removeClass(a.SIZE_LARGE);
			...
			createButton : function(e)
				{
					...
					if (typeof e.data === "object" && e.data.constructor === {}.constructor)
						{
							...
							if (typeof e.registeredButtonHotkeys[f.which] !== "undefined")
								{
									...
									!g.prop("disabled") && !g.is(":focus") && g.focus().trigger("click")
								}
						});
					return this
				},
			...
			realize : function()
				{
					...
					this.getModal().data("bs.modal", new c(this.getModalForBootstrapDialogModal(), {
						backdrop : "static",
						keyboard : false,
						show : false
					}));
		...
		a.alert = function()
			{
				...
				f.addButton({
					...
					action : function(h)
						{
							if (typeof h.getData("callback") === "function" && h.getData("callback").call(this, true) === false)
								{
									return false
								}
				...
				if (typeof f.options.onhide === "function")
					{
						f.onHide(function(h)
							{
								var i = true;
								if (!h.getData("btnClicked") && h.isClosable() && typeof h.getData("callback") === "function")
									{
		...
		a.confirm = function()
			{
				...
				var f =
					[ {
						...
						action : function(i)
							{
								if (typeof i.getData("callback") === "function" && i.getData("callback").call(this, false) === false)
									{
										return false
									}
								return i.close()
						...
						action : function(i)
							{
								if (typeof i.getData("callback") === "function" && i.getData("callback").call(this, true) === false)
									{
										return false
									}
								return i.close()
